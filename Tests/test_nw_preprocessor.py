...
def test_text(test_db):
    ...
    with tables.open_file(db_file, mode="r") as table:
        ...
        assert sentence1 == b"a good leader is a good communicator.", logging.error("Sentence: {} \n Expected instead: {}".format(sentence1, b"A good leader is a good communicator."))