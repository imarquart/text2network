...
# Condition the network
start_time = time.time()
semantic_network.condition(batchsize=100,weight_cutoff=0.1)
print("bolt ALL year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
logging.info("bolt ALL year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
print("nodes in network %i" % (len(semantic_network)))
print("ties in network %i" % (semantic_network.graph.number_of_edges()))
logging.info("nodes in network %i" % (len(semantic_network)))
logging.info("ties in network %i" % (semantic_network.graph.number_of_edges()))
...
start_time = time.time()
semantic_network.condition(batchsize=100,weight_cutoff=0.1)
print("http ALL year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
logging.info("http ALL year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
print("nodes in network %i" % (len(semantic_network)))
print("ties in network %i" % (semantic_network.graph.number_of_edges()))
logging.info("nodes in network %i" % (len(semantic_network)))
logging.info("ties in network %i" % (semantic_network.graph.number_of_edges()))
...
start_time = time.time()
semantic_network.condition(years=2009, batchsize=100,weight_cutoff=0.1)
print("http NORMED 1 year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
logging.info("http NORMED 1 year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
print("nodes in network %i" % (len(semantic_network)))
print("ties in network %i" % (semantic_network.graph.number_of_edges()))
logging.info("nodes in network %i" % (len(semantic_network)))
logging.info("ties in network %i" % (semantic_network.graph.number_of_edges()))
...
start_time = time.time()
semantic_network.condition(years=2009, batchsize=100,weight_cutoff=0.1)
print("bolt NORMED 1 year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
logging.info("bolt NORMED 1 year condition, batch 100, 0.1 cutoff %s seconds" % (time.time() - start_time))
print("nodes in network %i" % (len(semantic_network)))
print("ties in network %i" % (semantic_network.graph.number_of_edges()))
logging.info("nodes in network %i" % (len(semantic_network)))
logging.info("ties in network %i" % (semantic_network.graph.number_of_edges()))
