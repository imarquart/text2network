...
def list_stopwords():
    nltk_stopwords=["a", "about", "above", "after", "again", "against", "ain", "all", "am", "an", "and", "any", "are", "aren",
...
def create_stopword_list_old(tokenizer):
    """
    Return a list of tokenized tokens for words which should be removed from the data set
    ...
    delwords = np.union1d(delwords, numericals_ids)
    return delwords

def create_stopword_strings_old():
    """
    Return a list of tokenized tokens for words which should be removed from the data set
