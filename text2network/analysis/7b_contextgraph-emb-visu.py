...
sub_mode = ["bidirectional", "occurring", "substitution", ][0]  # "bidirectional"
algo = consensus_louvain
pos_list = ["NOUN", "ADJ", "VERB"]  # [0]
tf = ["weight", "diffw", "pmi_weight"][0]
keep_top_k = [50, 100, 200, 1000][-1]
max_degree = [50, 100, 200, 500][1]
level = 10  # [15, 10, 8, 6, 4, 2][1]
...
main_folder = "profile_relationships2_" + sub_mode + "_" + "_".join(pos_list)
main_folder = "profile_relationships2_bidirectional_ADJ_VERB_NOUN_ADV_ADP"
# main_folder="profile_relationships2_substitution_ADJ_VERB_NOUN_ADV_ADP"
...
# cluster_subset=["company", "team", "people", "organization", "make", "companies", "ceo", "leadership", "market", "best",]
cluster_subset = ["make", "people", "team", "manager", "leadership", "companies", "need", "leaders", "market", ]
cluster_subset = ["company", "team", "business", "people", "management", "time", "leadership", "organization", "must",
                  "good", "group", "executive", "ceo", "market", "make", ]
cluster_subset = ["company", "team", "business", "people", "management", "time", "leadership", "organization", "must",
                  "good", ]

# sub1kmd100
cluster_subset = ["company", "business", "team", "people", "organization", "good", "make", "time", "work", "management",
                  "leaders", "group", "companies", "ceo", "performance", ]

# bid1kmd100
cluster_subset = ["business", "company", "team", "people", "leadership", "work", "organization", "time", "management",
                  "ceo", "good", "make", "manager", "executive", "leaders", "best", "companies", "must", "performance",
                  "market", ][0:14]
...
year_list = [1980, 2021]
# year_list=list(range(1980,2025,5))
...
fig.suptitle(
    "{}-{}: Contextual clusters \n leader lvl {}, \n selected with {}".format(years[0], years[-1], level, tf),
    fontsize=14
)
...
ax.scatter(ch_frame["x"], ch_frame["y"], s=100, c=ch_frame.color, cmap="Pastel1")
            ...
            for time_diff in [True, False]:
                ...
                fig.suptitle(
                    "{}-{}: Contextual clusters \n leader vs {} \n lvl {}, \n diff {}, diff to other time periods {}".format(
                        ma_years[0], ma_years[-1], sel_alter, level, use_diff, time_diff), fontsize=12
                )
