...
weight_cutoff=None
depth=None
context=['ceo','firm','competition','company','industry']
norm=None
param_string="Years: {}, Tokens: {}, Cutoff: {}, Depth: {}, Context: {}, Norm: {}".format(years,tokens,weight_cutoff,depth,context,norm)
logging.info("------- {} -------".format(test_name))
logging.info(param_string)
...
logging.info("------------------------------------------------")
test_name="Normed ALL Year Conditioning"
tokens=None
years=[None]
weight_cutoff=None
depth=None
...
logging.info("------------------------------------------------")
test_name="Normed 1 Year Context Conditioning"
tokens=None
years=year_list
weight_cutoff=None
depth=None
...
logging.info("------------------------------------------------")
test_name="Normed ALL Year Context Conditioning"
tokens=None
years=[None]
weight_cutoff=None
depth=None
